...
describe('function node', function () {
    ...
    it.skip('should send to multiple messages', function (done) {
        var flow = [{
    ...
    it.skip('should handle null amongst valid messages', function (done) {
    ...
    it.skip('should access functionGlobalContext set via herlp settings()', function (done) {
    ...
    it.skip('should handle and log script error', function (done) {
    ...
    it.skip('should handle node.on()', function (done) {
    ...
    describe.skip('Logger', function () {
        ...
        it.skip('should log a Warning Message', function (done) {
